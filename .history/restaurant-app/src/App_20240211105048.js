...
function App() {
  ...
  return (
    <Container className={classes.container} maxWidth="md">    <Typography className={classes.title} gutterBottom variant="h2" align="center">
        Agriculture Juice Bar
        <div       <img src={myImage} alt="Description of the image" />
</div>
      </Typography>
      <Order />
    </Container>
